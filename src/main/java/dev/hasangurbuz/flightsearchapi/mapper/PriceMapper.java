...
import org.openapitools.model.CurrencyDTO;
...
public class PriceMapper {
    ...
    public PriceDTO toDto(Price price){
        ...
        dto.setCurrency(CurrencyDTO.valueOf(price.getCurrency().name()));
        return dto;
    }
    ...
    public Price toEntity(PriceDTO dto){
        ...
        price.setCurrency(Currency.valueOf(dto.getCurrency().name()));
        return price;
    }
